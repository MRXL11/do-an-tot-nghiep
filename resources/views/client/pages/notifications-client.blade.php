                            ...
                            <button class="accordion-button collapsed px-3 py-2 rounded" type="button" 
                                ...
                                <div>
                                    <span class="badge bg-primary mb-1">
                                        {{ $notification->type == 'promotion' ? 'Khuyến mãi' : ($notification->type == 'new_product' ? 'Sản phẩm mới' : 'Chính sách') }}
                                    </span>
                                    <div class="fw-semibold mb-1">
                                        {{ $notification->title }}
                                    </div>
                                    <small class="text-muted">Ngày nhận: {{ $notification->created_at->format(' H:i. d/m/Y') }}</small>
                                </div>
                            </button>
                        </h2>
