...
@section('content')
  ...
  <div class="row mb-4">
    <div class="col text-center">
      <h2 class="fw-bold">Chi tiết doanh thu</h2>
      <p class="text-muted">Tổng hợp doanh thu theo thời gian và bộ lọc tùy chọn</p>
    </div>
  </div>

  <div class="row">
    <!-- Cột trái: Hiển thị doanh thu -->
    <div class="col-md-8">
      <!-- Tabs Thống kê -->
      <ul class="nav nav-tabs mb-4" id="revenueTab" role="tablist">
        <li class="nav-item" role="presentation">
          <button class="nav-link active" id="day-tab" data-bs-toggle="tab" data-bs-target="#day" type="button">Theo ngày</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="week-tab" data-bs-toggle="tab" data-bs-target="#week" type="button">Theo tuần</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="month-tab" data-bs-toggle="tab" data-bs-target="#month" type="button">Theo tháng</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="year-tab" data-bs-toggle="tab" data-bs-target="#year" type="button">Theo năm</button>
        </li>
      </ul>
      ...
      <div class="tab-content" id="revenueTabContent">
          ...
          <div class="row row-cols-1 row-cols-md-2 g-4">
            ...
            <div class="col">
              <div class="card border-success text-center h-100">
                <div class="card-body">
                  <h6 class="card-title">Thuế (VAT)</h6>
                  <p class="fs-4 fw-bold">15,000₫</p>
                </div>
              </div>
            </div>
            <div class="col">
              <div class="card border-warning text-center h-100">
                <div class="card-body">
                  ...
                  <p class="fs-4 fw-bold">-10% (30,000₫)</p>
                </div>
              </div>
            </div>
            <div class="col">
              <div class="card border-danger text-center h-100">
                <div class="card-body">
                  ...
                  <p class="fs-4 fw-bold text-danger">1,320,000₫</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <!-- Các tab khác bạn có thể copy từ tab "day" và thay dữ liệu -->
        <div class="tab-pane fade" id="week" role="tabpanel">...</div>
        <div class="tab-pane fade" id="month" role="tabpanel">...</div>
        <div class="tab-pane fade" id="year" role="tabpanel">...</div>
      </div>
    </div>
    ...
    <aside class="col-md-4">
      <div class="card shadow-sm sticky-top" style="top: 80px;">
        <div class="card-header bg-primary text-white">
          <i class="bi bi-funnel-fill me-1"></i> Bộ lọc theo thời gian
        </div>
        <div class="card-body">
          <form>
            <div class="mb-3">
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-md-8">
                        <p class="text-center">
                          <strong>Ngày bán: 1 Jan, 2023 - 30 Jul, 2023</strong>
                        </p>
                    ...
                    <div class="d-flex flex-row justify-content-end">
                      ...
                      <!-- /.col -->
                      <div class="col-md-4">
                        <p class="text-center"><strong>Tiến độ hoàn thành</strong></p>
                        ...
                        <!-- /.progress-group -->
                        <div class="progress-group">
                          <span class="progress-text">Trả lời bình luận </span>
                    ...
                    <div class="row">
                      <div class="col-md-3 col-6">
                        <div class="text-center border-end">
                          ...
                          <span class="text-uppercase">Tổng doang thu toàn hệ thông</span>
                        </div>
                      </div>
                      <!-- /.col -->
                      <div class="col-md-3 col-6">
                        <div class="text-center border-end">
                          ...
                          <span class="text-uppercase">Tổng chi phi</span>
                        </div>
                      </div>
                      <!-- /.col -->
                      <div class="col-md-3 col-6">
                        <div class="text-center border-end">
                          ...
                          <span class="text-uppercase">Lợi nhuận</span>
                        </div>
                      </div>
                      <!-- /.col -->
                      <div class="col-md-3 col-6">
                ...
                <div class="card mb-4">
                  <div class="card-header border-0">
                    <div class="d-flex justify-content-between">
                      <h3 class="card-title">Người dùng online</h3>
                      <a
