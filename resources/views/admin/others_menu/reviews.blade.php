          ...
          <div class="card-body">
            ...
            <div class="mb-3 border-bottom pb-2">
              <div class="d-flex justify-content-between">
                <strong><i class="bi bi-person-circle me-1"></i>{{ $review->user->name ?? 'Khách' }}</strong>
              ...
              <small class="text-muted"><i class="bi bi-clock me-1"></i>{{ $review->created_at->format('d/m/Y') }}</small>
              ...
              <div class="mt-2">
                ...
                <form action="{{ route('admin.reviews.destroy', $review->id) }}" method="POST" class="d-inline">
                  @csrf
                  @method('DELETE')
                  <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Bạn có chắc muốn xoá đánh giá này?')">
