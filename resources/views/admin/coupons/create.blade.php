            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.coupons.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="code" id="code" class="form-control @error('code') is-invalid @enderror" value="{{ old('code') }}" maxlength="50" >
                        @error('code')
                    ...
                    <div class="mb-3">
                        ...
                        <select name="discount_type" id="discount_type" class="form-control @error('discount_type') is-invalid @enderror" >
                            <option value="" disabled {{ old('discount_type') ? '' : 'selected' }}>Chọn loại</option>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="discount_value" id="discount_value" class="form-control @error('discount_value') is-invalid @enderror" step="0.01" min="0" value="{{ old('discount_value') }}" >
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="min_order_value" id="min_order_value" class="form-control @error('min_order_value') is-invalid @enderror" step="0.01" min="0" value="{{ old('min_order_value') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="max_discount" id="max_discount" class="form-control @error('max_discount') is-invalid @enderror" step="0.01" min="0" value="{{ old('max_discount') }}">
                        @error('max_discount')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
